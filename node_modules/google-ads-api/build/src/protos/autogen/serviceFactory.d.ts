...
export default class ServiceFactory extends Service {
    ...
    get reservations(): {
         ...
         */
        quoteCampaigns: (request: services.QuoteCampaignsRequest) => Promise<services.QuoteCampaignsResponse>;
        /**
         * @link https://developers.google.com/google-ads/api/reference/rpc/v24/ReservationService#bookcampaigns
         */
        bookCampaigns: (request: services.BookCampaignsRequest) => Promise<services.BookCampaignsResponse>;
    };
    /**
    ...
    get youTubeVideoUploads(): {
         ...
         */
        createYouTubeVideoUpload: (request: services.CreateYouTubeVideoUploadRequest) => Promise<services.CreateYouTubeVideoUploadResponse>;
        /**
         * @link https://developers.google.com/google-ads/api/reference/rpc/v24/YouTubeVideoUploadService#updateyoutubevideoupload
         */
        updateYouTubeVideoUpload: (request: services.UpdateYouTubeVideoUploadRequest) => Promise<services.UpdateYouTubeVideoUploadResponse>;
        /**
         * @link https://developers.google.com/google-ads/api/reference/rpc/v24/YouTubeVideoUploadService#removeyoutubevideoupload
         */
        removeYouTubeVideoUpload: (request: services.RemoveYouTubeVideoUploadRequest) => Promise<services.RemoveYouTubeVideoUploadResponse>;
    };
}
