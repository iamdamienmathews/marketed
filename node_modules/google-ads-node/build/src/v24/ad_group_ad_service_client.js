 ...
 * `src/v24/ad_group_ad_service_client_config.json`.
...
class AdGroupAdServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AdGroupAdService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupAdServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AdGroupAdService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AdGroupAdService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroupAds(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAdGroupAds(request, options, wrappedCallback)
    ...
    removeAutomaticallyCreatedAssets(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .removeAutomaticallyCreatedAssets(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('removeAutomaticallyCreatedAssets response %j', response);
            return [response, options, rawResponse];
        })
