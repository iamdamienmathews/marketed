 ...
 * `src/v24/campaign_asset_set_service_client_config.json`.
...
class CampaignAssetSetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CampaignAssetSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignAssetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CampaignAssetSetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CampaignAssetSetService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignAssetSets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCampaignAssetSets(request, options, wrappedCallback)
