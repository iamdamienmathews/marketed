 ...
 * `src/v24/customer_manager_link_service_client_config.json`.
...
class CustomerManagerLinkServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CustomerManagerLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerManagerLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CustomerManagerLinkService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CustomerManagerLinkService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerManagerLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCustomerManagerLink(request, options, wrappedCallback)
    ...
    moveManagerLink(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .moveManagerLink(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('moveManagerLink response %j', response);
            return [response, options, rawResponse];
        })
