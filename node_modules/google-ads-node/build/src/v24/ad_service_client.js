 ...
 * `src/v24/ad_service_client_config.json`.
...
class AdServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AdService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AdService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services.AdService, this._opts, this._providedCustomServicePath);
    ...
    mutateAds(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAds(request, options, wrappedCallback)
