 ...
 * `src/v24/campaign_customizer_service_client_config.json`.
...
class CampaignCustomizerServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CampaignCustomizerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CampaignCustomizerService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CampaignCustomizerService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignCustomizers(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCampaignCustomizers(request, options, wrappedCallback)
