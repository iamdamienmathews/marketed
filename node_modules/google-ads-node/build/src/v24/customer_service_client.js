 ...
 * `src/v24/customer_service_client_config.json`.
...
class CustomerServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CustomerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CustomerService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CustomerService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomer(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCustomer(request, options, wrappedCallback)
    ...
    listAccessibleCustomers(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .listAccessibleCustomers(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listAccessibleCustomers response %j', response);
            return [response, options, rawResponse];
        })
    ...
    createCustomerClient(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .createCustomerClient(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('createCustomerClient response %j', response);
            return [response, options, rawResponse];
        })
