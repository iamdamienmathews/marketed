 ...
 * `src/v24/campaign_asset_service_client_config.json`.
...
class CampaignAssetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CampaignAssetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CampaignAssetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CampaignAssetService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCampaignAssets(request, options, wrappedCallback)
