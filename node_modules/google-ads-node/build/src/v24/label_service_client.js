 ...
 * `src/v24/label_service_client_config.json`.
...
class LabelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.LabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.labelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.LabelService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services.LabelService, this._opts, this._providedCustomServicePath);
    ...
    mutateLabels(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateLabels(request, options, wrappedCallback)
