 ...
 * `src/v24/campaign_group_service_client_config.json`.
...
class CampaignGroupServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CampaignGroupService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignGroupServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CampaignGroupService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CampaignGroupService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignGroups(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCampaignGroups(request, options, wrappedCallback)
