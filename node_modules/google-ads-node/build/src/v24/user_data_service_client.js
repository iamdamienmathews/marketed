 ...
 * `src/v24/user_data_service_client_config.json`.
...
class UserDataServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.UserDataService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.userDataServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.UserDataService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .UserDataService, this._opts, this._providedCustomServicePath);
    ...
    uploadUserData(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .uploadUserData(request, options, wrappedCallback)
