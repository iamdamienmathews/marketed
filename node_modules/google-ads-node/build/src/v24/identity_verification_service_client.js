 ...
 * `src/v24/identity_verification_service_client_config.json`.
...
class IdentityVerificationServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.IdentityVerificationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.identityVerificationServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.IdentityVerificationService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .IdentityVerificationService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const identityVerificationServiceStubMethods = [
    ...
    startIdentityVerification(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .startIdentityVerification(request, options, wrappedCallback)
    ...
    getIdentityVerification(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .getIdentityVerification(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('getIdentityVerification response %j', response);
            return [response, options, rawResponse];
        })
