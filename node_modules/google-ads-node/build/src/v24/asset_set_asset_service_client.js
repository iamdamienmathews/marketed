 ...
 * `src/v24/asset_set_asset_service_client_config.json`.
...
class AssetSetAssetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AssetSetAssetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.assetSetAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AssetSetAssetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AssetSetAssetService, this._opts, this._providedCustomServicePath);
    ...
    mutateAssetSetAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAssetSetAssets(request, options, wrappedCallback)
