 ...
 * `src/v24/ad_group_service_client_config.json`.
...
class AdGroupServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AdGroupService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AdGroupService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AdGroupService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroups(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAdGroups(request, options, wrappedCallback)
