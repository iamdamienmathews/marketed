 ...
 * `src/v24/customer_customizer_service_client_config.json`.
...
class CustomerCustomizerServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CustomerCustomizerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CustomerCustomizerService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CustomerCustomizerService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerCustomizers(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCustomerCustomizers(request, options, wrappedCallback)
