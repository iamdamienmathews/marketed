 ...
 * `src/v24/asset_group_signal_service_client_config.json`.
...
class AssetGroupSignalServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AssetGroupSignalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.assetGroupSignalServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AssetGroupSignalService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AssetGroupSignalService, this._opts, this._providedCustomServicePath);
    ...
    mutateAssetGroupSignals(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAssetGroupSignals(request, options, wrappedCallback)
