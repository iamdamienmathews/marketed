 ...
 * `src/v24/experiment_service_client_config.json`.
...
class ExperimentServiceClient {
    ...
    constructor(opts, gaxInstance) {
            ...
            lroOptions.httpRules = [
                {
                    ...
                    post: '/v24/{name=customers/*/operations/*}:cancel',
                    body: '*',
                },
                {
                    selector: 'google.longrunning.Operations.DeleteOperation',
                    delete: '/v24/{name=customers/*/operations/*}',
                },
                {
                    selector: 'google.longrunning.Operations.GetOperation',
                    get: '/v24/{name=customers/*/operations/*}',
                },
                {
                ...
                },
                {
                    ...
                    post: '/v24/{name=customers/*/operations/*}:wait',
                    body: '*',
                },
            ];
        }
        ...
        const scheduleExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v24.services.ScheduleExperimentMetadata');
        const promoteExperimentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const promoteExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v24.services.PromoteExperimentMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.ExperimentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.experimentServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.ExperimentService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .ExperimentService, this._opts, this._providedCustomServicePath);
    ...
    mutateExperiments(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateExperiments(request, options, wrappedCallback)
    ...
    endExperiment(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .endExperiment(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('endExperiment response %j', response);
            return [response, options, rawResponse];
        })
    ...
    graduateExperiment(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .graduateExperiment(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('graduateExperiment response %j', response);
            return [response, options, rawResponse];
        })
    ...
    scheduleExperiment(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .scheduleExperiment(request, options, wrappedCallback)
    ...
    promoteExperiment(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .promoteExperiment(request, options, wrappedCallback)
            ?.then(([response, rawResponse, _]) => {
            this._log.info('promoteExperiment response %j', rawResponse);
            return [response, rawResponse, _];
        });
