 ...
 * `src/v24/recommendation_service_client_config.json`.
...
class RecommendationServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.RecommendationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.recommendationServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.RecommendationService')
    ...
    applyRecommendation(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .applyRecommendation(request, options, wrappedCallback)
    ...
    dismissRecommendation(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .dismissRecommendation(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('dismissRecommendation response %j', response);
            return [response, options, rawResponse];
        })
    ...
    generateRecommendations(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .generateRecommendations(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateRecommendations response %j', response);
            return [response, options, rawResponse];
        })
