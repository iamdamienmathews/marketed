 ...
 * `src/v24/audience_insights_service_client_config.json`.
...
class AudienceInsightsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AudienceInsightsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.audienceInsightsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AudienceInsightsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AudienceInsightsService, this._opts, this._providedCustomServicePath);
    ...
    generateInsightsFinderReport(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .generateInsightsFinderReport(request, options, wrappedCallback)
    ...
    listAudienceInsightsAttributes(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .listAudienceInsightsAttributes(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listAudienceInsightsAttributes response %j', response);
            return [response, options, rawResponse];
        })
    ...
    listInsightsEligibleDates(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .listInsightsEligibleDates(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listInsightsEligibleDates response %j', response);
            return [response, options, rawResponse];
        })
    ...
    generateAudienceCompositionInsights(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .generateAudienceCompositionInsights(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateAudienceCompositionInsights response %j', response);
            return [response, options, rawResponse];
        })
    ...
    generateAudienceDefinition(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .generateAudienceDefinition(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateAudienceDefinition response %j', response);
            return [response, options, rawResponse];
        })
    ...
    generateSuggestedTargetingInsights(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .generateSuggestedTargetingInsights(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateSuggestedTargetingInsights response %j', response);
            return [response, options, rawResponse];
        })
    ...
    generateAudienceOverlapInsights(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .generateAudienceOverlapInsights(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateAudienceOverlapInsights response %j', response);
            return [response, options, rawResponse];
        })
    ...
    generateTargetingSuggestionMetrics(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .generateTargetingSuggestionMetrics(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateTargetingSuggestionMetrics response %j', response);
            return [response, options, rawResponse];
        })
