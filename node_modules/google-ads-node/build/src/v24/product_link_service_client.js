 ...
 * `src/v24/product_link_service_client_config.json`.
...
class ProductLinkServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.ProductLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.productLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.ProductLinkService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .ProductLinkService, this._opts, this._providedCustomServicePath);
    ...
    createProductLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .createProductLink(request, options, wrappedCallback)
    ...
    removeProductLink(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .removeProductLink(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('removeProductLink response %j', response);
            return [response, options, rawResponse];
        })
