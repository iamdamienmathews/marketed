 ...
 * `src/v24/customer_negative_criterion_service_client_config.json`.
...
class CustomerNegativeCriterionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CustomerNegativeCriterionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerNegativeCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CustomerNegativeCriterionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CustomerNegativeCriterionService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerNegativeCriteria(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCustomerNegativeCriteria(request, options, wrappedCallback)
