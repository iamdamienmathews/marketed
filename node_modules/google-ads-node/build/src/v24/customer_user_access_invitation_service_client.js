 ...
 * `src/v24/customer_user_access_invitation_service_client_config.json`.
...
class CustomerUserAccessInvitationServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CustomerUserAccessInvitationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerUserAccessInvitationServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CustomerUserAccessInvitationService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CustomerUserAccessInvitationService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerUserAccessInvitation(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCustomerUserAccessInvitation(request, options, wrappedCallback)
