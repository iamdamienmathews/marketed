 ...
 * `src/v24/benchmarks_service_client_config.json`.
...
class BenchmarksServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.BenchmarksService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.benchmarksServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.BenchmarksService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .BenchmarksService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const benchmarksServiceStubMethods = [
    ...
    listBenchmarksAvailableDates(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .listBenchmarksAvailableDates(request, options, wrappedCallback)
    ...
    listBenchmarksLocations(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .listBenchmarksLocations(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listBenchmarksLocations response %j', response);
            return [response, options, rawResponse];
        })
    ...
    listBenchmarksProducts(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .listBenchmarksProducts(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listBenchmarksProducts response %j', response);
            return [response, options, rawResponse];
        })
    ...
    listBenchmarksSources(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .listBenchmarksSources(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listBenchmarksSources response %j', response);
            return [response, options, rawResponse];
        })
    ...
    generateBenchmarksMetrics(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .generateBenchmarksMetrics(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateBenchmarksMetrics response %j', response);
            return [response, options, rawResponse];
        })
