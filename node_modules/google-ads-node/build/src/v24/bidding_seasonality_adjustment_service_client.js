 ...
 * `src/v24/bidding_seasonality_adjustment_service_client_config.json`.
...
class BiddingSeasonalityAdjustmentServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.BiddingSeasonalityAdjustmentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.biddingSeasonalityAdjustmentServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.BiddingSeasonalityAdjustmentService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .BiddingSeasonalityAdjustmentService, this._opts, this._providedCustomServicePath);
    ...
    mutateBiddingSeasonalityAdjustments(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateBiddingSeasonalityAdjustments(request, options, wrappedCallback)
