 ...
 * `src/v24/asset_group_listing_group_filter_service_client_config.json`.
...
class AssetGroupListingGroupFilterServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AssetGroupListingGroupFilterService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.assetGroupListingGroupFilterServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AssetGroupListingGroupFilterService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AssetGroupListingGroupFilterService, this._opts, this._providedCustomServicePath);
    ...
    mutateAssetGroupListingGroupFilters(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAssetGroupListingGroupFilters(request, options, wrappedCallback)
