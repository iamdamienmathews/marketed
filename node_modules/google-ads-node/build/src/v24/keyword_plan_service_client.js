 ...
 * `src/v24/keyword_plan_service_client_config.json`.
...
class KeywordPlanServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.KeywordPlanService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.KeywordPlanService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .KeywordPlanService, this._opts, this._providedCustomServicePath);
    ...
    mutateKeywordPlans(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateKeywordPlans(request, options, wrappedCallback)
