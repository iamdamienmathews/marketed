 ...
 * `src/v24/third_party_app_analytics_link_service_client_config.json`.
...
class ThirdPartyAppAnalyticsLinkServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.ThirdPartyAppAnalyticsLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.thirdPartyAppAnalyticsLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.ThirdPartyAppAnalyticsLinkService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .ThirdPartyAppAnalyticsLinkService, this._opts, this._providedCustomServicePath);
    ...
    regenerateShareableLinkId(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .regenerateShareableLinkId(request, options, wrappedCallback)
