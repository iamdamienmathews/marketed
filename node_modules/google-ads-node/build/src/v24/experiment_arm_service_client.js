 ...
 * `src/v24/experiment_arm_service_client_config.json`.
...
class ExperimentArmServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.ExperimentArmService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.experimentArmServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.ExperimentArmService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .ExperimentArmService, this._opts, this._providedCustomServicePath);
    ...
    mutateExperimentArms(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateExperimentArms(request, options, wrappedCallback)
