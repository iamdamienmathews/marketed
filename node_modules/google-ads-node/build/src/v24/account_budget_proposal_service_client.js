 ...
 * `src/v24/account_budget_proposal_service_client_config.json`.
...
class AccountBudgetProposalServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AccountBudgetProposalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.accountBudgetProposalServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AccountBudgetProposalService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AccountBudgetProposalService, this._opts, this._providedCustomServicePath);
    ...
    mutateAccountBudgetProposal(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAccountBudgetProposal(request, options, wrappedCallback)
