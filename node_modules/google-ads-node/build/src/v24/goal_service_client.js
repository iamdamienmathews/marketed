 ...
 * `src/v24/goal_service_client_config.json`.
...
class GoalServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.GoalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.goalServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.GoalService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services.GoalService, this._opts, this._providedCustomServicePath);
    ...
    mutateGoals(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateGoals(request, options, wrappedCallback)
