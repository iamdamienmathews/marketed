 ...
 * `src/v24/customer_asset_service_client_config.json`.
...
class CustomerAssetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CustomerAssetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CustomerAssetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CustomerAssetService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCustomerAssets(request, options, wrappedCallback)
