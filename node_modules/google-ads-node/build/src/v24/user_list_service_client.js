 ...
 * `src/v24/user_list_service_client_config.json`.
...
class UserListServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.UserListService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.userListServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.UserListService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .UserListService, this._opts, this._providedCustomServicePath);
    ...
    mutateUserLists(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateUserLists(request, options, wrappedCallback)
