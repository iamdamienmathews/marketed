 ...
 * `src/v24/smart_campaign_suggest_service_client_config.json`.
...
class SmartCampaignSuggestServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.SmartCampaignSuggestService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.smartCampaignSuggestServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.SmartCampaignSuggestService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .SmartCampaignSuggestService, this._opts, this._providedCustomServicePath);
    ...
    suggestSmartCampaignBudgetOptions(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .suggestSmartCampaignBudgetOptions(request, options, wrappedCallback)
    ...
    suggestSmartCampaignAd(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .suggestSmartCampaignAd(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('suggestSmartCampaignAd response %j', response);
            return [response, options, rawResponse];
        })
    ...
    suggestKeywordThemes(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .suggestKeywordThemes(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('suggestKeywordThemes response %j', response);
            return [response, options, rawResponse];
        })
