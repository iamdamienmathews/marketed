 ...
 * `src/v24/travel_asset_suggestion_service_client_config.json`.
...
class TravelAssetSuggestionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.TravelAssetSuggestionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.travelAssetSuggestionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.TravelAssetSuggestionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .TravelAssetSuggestionService, this._opts, this._providedCustomServicePath);
    ...
    suggestTravelAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .suggestTravelAssets(request, options, wrappedCallback)
