 ...
 * `src/v24/recommendation_subscription_service_client_config.json`.
...
class RecommendationSubscriptionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.RecommendationSubscriptionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.recommendationSubscriptionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.RecommendationSubscriptionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .RecommendationSubscriptionService, this._opts, this._providedCustomServicePath);
    ...
    mutateRecommendationSubscription(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateRecommendationSubscription(request, options, wrappedCallback)
