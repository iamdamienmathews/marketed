 ...
 * `src/v24/campaign_criterion_service_client_config.json`.
...
class CampaignCriterionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CampaignCriterionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CampaignCriterionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CampaignCriterionService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignCriteria(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCampaignCriteria(request, options, wrappedCallback)
