 ...
 * `src/v24/customizer_attribute_service_client_config.json`.
...
class CustomizerAttributeServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CustomizerAttributeService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customizerAttributeServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CustomizerAttributeService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CustomizerAttributeService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomizerAttributes(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCustomizerAttributes(request, options, wrappedCallback)
