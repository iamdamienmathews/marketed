 ...
 * `src/v24/campaign_goal_config_service_client_config.json`.
...
class CampaignGoalConfigServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CampaignGoalConfigService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignGoalConfigServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CampaignGoalConfigService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CampaignGoalConfigService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignGoalConfigs(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCampaignGoalConfigs(request, options, wrappedCallback)
