 ...
 * `src/v24/campaign_label_service_client_config.json`.
...
class CampaignLabelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CampaignLabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CampaignLabelService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CampaignLabelService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignLabels(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCampaignLabels(request, options, wrappedCallback)
