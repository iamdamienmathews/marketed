 ...
 * `src/v24/smart_campaign_setting_service_client_config.json`.
...
class SmartCampaignSettingServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.SmartCampaignSettingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.smartCampaignSettingServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.SmartCampaignSettingService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .SmartCampaignSettingService, this._opts, this._providedCustomServicePath);
    ...
    getSmartCampaignStatus(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .getSmartCampaignStatus(request, options, wrappedCallback)
    ...
    mutateSmartCampaignSettings(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .mutateSmartCampaignSettings(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('mutateSmartCampaignSettings response %j', response);
            return [response, options, rawResponse];
        })
