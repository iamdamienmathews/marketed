 ...
 * `src/v24/incentive_service_client_config.json`.
...
class IncentiveServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.IncentiveService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.incentiveServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.IncentiveService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .IncentiveService, this._opts, this._providedCustomServicePath);
    ...
    fetchIncentive(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .fetchIncentive(request, options, wrappedCallback)
    ...
    applyIncentive(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .applyIncentive(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('applyIncentive response %j', response);
            return [response, options, rawResponse];
        })
