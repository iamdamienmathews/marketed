 ...
 * `src/v24/ad_parameter_service_client_config.json`.
...
class AdParameterServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AdParameterService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adParameterServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AdParameterService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AdParameterService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdParameters(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAdParameters(request, options, wrappedCallback)
