 ...
 * `src/v24/ad_group_ad_label_service_client_config.json`.
...
class AdGroupAdLabelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AdGroupAdLabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupAdLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AdGroupAdLabelService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AdGroupAdLabelService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroupAdLabels(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAdGroupAdLabels(request, options, wrappedCallback)
