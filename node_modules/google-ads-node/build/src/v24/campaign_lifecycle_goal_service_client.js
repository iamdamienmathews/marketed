 ...
 * `src/v24/campaign_lifecycle_goal_service_client_config.json`.
...
class CampaignLifecycleGoalServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CampaignLifecycleGoalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignLifecycleGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CampaignLifecycleGoalService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CampaignLifecycleGoalService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const campaignLifecycleGoalServiceStubMethods = [
    ...
    configureCampaignLifecycleGoals(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .configureCampaignLifecycleGoals(request, options, wrappedCallback)
