 ...
 * `src/v24/campaign_budget_service_client_config.json`.
...
class CampaignBudgetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CampaignBudgetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignBudgetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CampaignBudgetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CampaignBudgetService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignBudgets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCampaignBudgets(request, options, wrappedCallback)
