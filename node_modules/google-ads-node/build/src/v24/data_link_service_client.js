 ...
 * `src/v24/data_link_service_client_config.json`.
...
class DataLinkServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.DataLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.dataLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.DataLinkService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .DataLinkService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const dataLinkServiceStubMethods = [
            'createDataLink',
            'removeDataLink',
            'updateDataLink',
        ];
    ...
    createDataLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .createDataLink(request, options, wrappedCallback)
    ...
    removeDataLink(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .removeDataLink(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('removeDataLink response %j', response);
            return [response, options, rawResponse];
        })
    ...
    updateDataLink(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .updateDataLink(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('updateDataLink response %j', response);
            return [response, options, rawResponse];
        })
