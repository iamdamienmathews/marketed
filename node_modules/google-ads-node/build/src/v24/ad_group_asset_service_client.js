 ...
 * `src/v24/ad_group_asset_service_client_config.json`.
...
class AdGroupAssetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AdGroupAssetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AdGroupAssetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AdGroupAssetService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroupAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAdGroupAssets(request, options, wrappedCallback)
