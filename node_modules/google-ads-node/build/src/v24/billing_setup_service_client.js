 ...
 * `src/v24/billing_setup_service_client_config.json`.
...
class BillingSetupServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.BillingSetupService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.billingSetupServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.BillingSetupService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .BillingSetupService, this._opts, this._providedCustomServicePath);
    ...
    mutateBillingSetup(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateBillingSetup(request, options, wrappedCallback)
