 ...
 * `src/v24/keyword_theme_constant_service_client_config.json`.
...
class KeywordThemeConstantServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.KeywordThemeConstantService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordThemeConstantServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.KeywordThemeConstantService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .KeywordThemeConstantService, this._opts, this._providedCustomServicePath);
    ...
    suggestKeywordThemeConstants(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .suggestKeywordThemeConstants(request, options, wrappedCallback)
