 ...
 * `src/v24/offline_user_data_job_service_client_config.json`.
...
class OfflineUserDataJobServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const runOfflineUserDataJobMetadata = protoFilesRoot.lookup('.google.ads.googleads.v24.resources.OfflineUserDataJobMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.OfflineUserDataJobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.offlineUserDataJobServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.OfflineUserDataJobService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .OfflineUserDataJobService, this._opts, this._providedCustomServicePath);
    ...
    createOfflineUserDataJob(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .createOfflineUserDataJob(request, options, wrappedCallback)
    ...
    addOfflineUserDataJobOperations(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .addOfflineUserDataJobOperations(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('addOfflineUserDataJobOperations response %j', response);
            return [response, options, rawResponse];
        })
    ...
    runOfflineUserDataJob(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .runOfflineUserDataJob(request, options, wrappedCallback)
     ...
     * @example <caption>include:samples/generated/v24/offline_user_data_job_service.run_offline_user_data_job.js</caption>
     * region_tag:googleads_v24_generated_OfflineUserDataJobService_RunOfflineUserDataJob_async
     */
