 ...
 * `src/v24/campaign_service_client_config.json`.
...
class CampaignServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CampaignService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CampaignService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CampaignService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaigns(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCampaigns(request, options, wrappedCallback)
    ...
    enablePMaxBrandGuidelines(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .enablePMaxBrandGuidelines(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('enablePMaxBrandGuidelines response %j', response);
            return [response, options, rawResponse];
        })
