 ...
 * `src/v24/payments_account_service_client_config.json`.
...
class PaymentsAccountServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.PaymentsAccountService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.paymentsAccountServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.PaymentsAccountService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .PaymentsAccountService, this._opts, this._providedCustomServicePath);
    ...
    listPaymentsAccounts(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .listPaymentsAccounts(request, options, wrappedCallback)
