 ...
 * `src/v24/shared_set_service_client_config.json`.
...
class SharedSetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.SharedSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.sharedSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.SharedSetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .SharedSetService, this._opts, this._providedCustomServicePath);
    ...
    mutateSharedSets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateSharedSets(request, options, wrappedCallback)
