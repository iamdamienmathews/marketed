 ...
 * `src/v24/custom_interest_service_client_config.json`.
...
class CustomInterestServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CustomInterestService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customInterestServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CustomInterestService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CustomInterestService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomInterests(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCustomInterests(request, options, wrappedCallback)
