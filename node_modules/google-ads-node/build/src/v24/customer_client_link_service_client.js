 ...
 * `src/v24/customer_client_link_service_client_config.json`.
...
class CustomerClientLinkServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CustomerClientLinkService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerClientLinkServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CustomerClientLinkService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CustomerClientLinkService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerClientLink(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCustomerClientLink(request, options, wrappedCallback)
