 ...
 * `src/v24/remarketing_action_service_client_config.json`.
...
class RemarketingActionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.RemarketingActionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.remarketingActionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.RemarketingActionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .RemarketingActionService, this._opts, this._providedCustomServicePath);
    ...
    mutateRemarketingActions(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateRemarketingActions(request, options, wrappedCallback)
