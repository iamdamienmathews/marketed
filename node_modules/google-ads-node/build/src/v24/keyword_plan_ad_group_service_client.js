 ...
 * `src/v24/keyword_plan_ad_group_service_client_config.json`.
...
class KeywordPlanAdGroupServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.KeywordPlanAdGroupService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanAdGroupServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.KeywordPlanAdGroupService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .KeywordPlanAdGroupService, this._opts, this._providedCustomServicePath);
    ...
    mutateKeywordPlanAdGroups(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateKeywordPlanAdGroups(request, options, wrappedCallback)
