 ...
 * `src/v24/invoice_service_client_config.json`.
...
class InvoiceServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.InvoiceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.invoiceServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.InvoiceService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .InvoiceService, this._opts, this._providedCustomServicePath);
    ...
    listInvoices(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .listInvoices(request, options, wrappedCallback)
