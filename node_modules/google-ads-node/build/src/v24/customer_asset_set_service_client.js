 ...
 * `src/v24/customer_asset_set_service_client_config.json`.
...
class CustomerAssetSetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CustomerAssetSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerAssetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CustomerAssetSetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CustomerAssetSetService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerAssetSets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCustomerAssetSets(request, options, wrappedCallback)
