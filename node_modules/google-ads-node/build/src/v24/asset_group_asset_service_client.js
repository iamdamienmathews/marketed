 ...
 * `src/v24/asset_group_asset_service_client_config.json`.
...
class AssetGroupAssetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AssetGroupAssetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.assetGroupAssetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AssetGroupAssetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AssetGroupAssetService, this._opts, this._providedCustomServicePath);
    ...
    mutateAssetGroupAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAssetGroupAssets(request, options, wrappedCallback)
