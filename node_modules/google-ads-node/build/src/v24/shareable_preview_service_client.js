 ...
 * `src/v24/shareable_preview_service_client_config.json`.
...
class ShareablePreviewServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.ShareablePreviewService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.shareablePreviewServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.ShareablePreviewService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .ShareablePreviewService, this._opts, this._providedCustomServicePath);
    ...
    generateShareablePreviews(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .generateShareablePreviews(request, options, wrappedCallback)
