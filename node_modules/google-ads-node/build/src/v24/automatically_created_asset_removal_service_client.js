 ...
 * `src/v24/automatically_created_asset_removal_service_client_config.json`.
...
class AutomaticallyCreatedAssetRemovalServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AutomaticallyCreatedAssetRemovalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.automaticallyCreatedAssetRemovalServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AutomaticallyCreatedAssetRemovalService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AutomaticallyCreatedAssetRemovalService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const automaticallyCreatedAssetRemovalServiceStubMethods = [
    ...
    removeCampaignAutomaticallyCreatedAsset(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .removeCampaignAutomaticallyCreatedAsset(request, options, wrappedCallback)
