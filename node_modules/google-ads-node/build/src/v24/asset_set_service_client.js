 ...
 * `src/v24/asset_set_service_client_config.json`.
...
class AssetSetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AssetSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.assetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AssetSetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AssetSetService, this._opts, this._providedCustomServicePath);
    ...
    mutateAssetSets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAssetSets(request, options, wrappedCallback)
