 ...
 * `src/v24/campaign_bid_modifier_service_client_config.json`.
...
class CampaignBidModifierServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CampaignBidModifierService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.campaignBidModifierServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CampaignBidModifierService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CampaignBidModifierService, this._opts, this._providedCustomServicePath);
    ...
    mutateCampaignBidModifiers(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCampaignBidModifiers(request, options, wrappedCallback)
