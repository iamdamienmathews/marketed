...
exports.YouTubeVideoUploadServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v24/you_tube_video_upload_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./you_tube_video_upload_service_client_config.json");
...
class YouTubeVideoUploadServiceClient {
    ...
    innerApiCalls;
    pathTemplates;
    youTubeVideoUploadServiceStub;
    /**
     * Construct an instance of YouTubeVideoUploadServiceClient.
     *
     ...
     *     const client = new YouTubeVideoUploadServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            appTopCombinationViewPathTemplate: new this._gaxModule.PathTemplate('customers/{customer_id}/appTopCombinationViews/{ad_group_id}~{ad_id}~{asset_combination_category}'),
            ...
            cartDataSalesViewPathTemplate: new this._gaxModule.PathTemplate('customers/{customer_id}/cartDataSalesView'),
            ...
            videoEnhancementPathTemplate: new this._gaxModule.PathTemplate('customers/{customer_id}/videoEnhancements/{video_enhancement}'),
            webpageViewPathTemplate: new this._gaxModule.PathTemplate('customers/{customer_id}/webpageViews/{ad_group_id}~{criterion_id}'),
            youTubeVideoUploadPathTemplate: new this._gaxModule.PathTemplate('customers/{customer_id}/youTubeVideoUploads/{video_upload_id}'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.YouTubeVideoUploadService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.youTubeVideoUploadServiceStub) {
            return this.youTubeVideoUploadServiceStub;
        }
        // Put together the "service stub" for
        // google.ads.googleads.v24.services.YouTubeVideoUploadService.
        this.youTubeVideoUploadServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.YouTubeVideoUploadService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .YouTubeVideoUploadService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const youTubeVideoUploadServiceStubMethods = [
            'createYouTubeVideoUpload',
            'updateYouTubeVideoUpload',
            'removeYouTubeVideoUpload',
        ];
        for (const methodName of youTubeVideoUploadServiceStubMethods) {
            const callPromise = this.youTubeVideoUploadServiceStub.then((stub) => (...args) => {
                if (this._terminated) {
    ...
    createYouTubeVideoUpload(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('createYouTubeVideoUpload request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('createYouTubeVideoUpload response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls
            .createYouTubeVideoUpload(request, options, wrappedCallback)
    ...
    updateYouTubeVideoUpload(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this._log.info('updateYouTubeVideoUpload request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('updateYouTubeVideoUpload response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls
            .updateYouTubeVideoUpload(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('updateYouTubeVideoUpload response %j', response);
            return [response, options, rawResponse];
        })
    ...
    removeYouTubeVideoUpload(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this._log.info('removeYouTubeVideoUpload request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('removeYouTubeVideoUpload response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls
            .removeYouTubeVideoUpload(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('removeYouTubeVideoUpload response %j', response);
            return [response, options, rawResponse];
        })
    ...
    matchCustomerIdFromAccountBudgetName(accountBudgetName) {
        return this.pathTemplates.accountBudgetPathTemplate.match(accountBudgetName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromAccountLinkName(accountLinkName) {
        return this.pathTemplates.accountLinkPathTemplate.match(accountLinkName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromAdGroupName(adGroupName) {
        return this.pathTemplates.adGroupPathTemplate.match(adGroupName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromAdGroupAdName(adGroupAdName) {
        return this.pathTemplates.adGroupAdPathTemplate.match(adGroupAdName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromAdGroupAssetName(adGroupAssetName) {
        return this.pathTemplates.adGroupAssetPathTemplate.match(adGroupAssetName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromAdGroupLabelName(adGroupLabelName) {
        return this.pathTemplates.adGroupLabelPathTemplate.match(adGroupLabelName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromAdParameterName(adParameterName) {
        return this.pathTemplates.adParameterPathTemplate.match(adParameterName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromAgeRangeViewName(ageRangeViewName) {
        return this.pathTemplates.ageRangeViewPathTemplate.match(ageRangeViewName)
            .customer_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    appTopCombinationViewPath(customerId, adGroupId, adId, assetCombinationCategory) {
        return this.pathTemplates.appTopCombinationViewPathTemplate.render({
            customer_id: customerId,
            ad_group_id: adGroupId,
            ad_id: adId,
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromAppTopCombinationViewName(appTopCombinationViewName) {
        return this.pathTemplates.appTopCombinationViewPathTemplate.match(appTopCombinationViewName).customer_id;
    }
    /**
     ...
     * @returns {string} A string representing the ad_group_id.
     */
    matchAdGroupIdFromAppTopCombinationViewName(appTopCombinationViewName) {
        return this.pathTemplates.appTopCombinationViewPathTemplate.match(appTopCombinationViewName).ad_group_id;
    }
    /**
     ...
     * @returns {string} A string representing the ad_id.
     */
    matchAdIdFromAppTopCombinationViewName(appTopCombinationViewName) {
        return this.pathTemplates.appTopCombinationViewPathTemplate.match(appTopCombinationViewName).ad_id;
    }
    /**
     ...
     */
    matchAssetCombinationCategoryFromAppTopCombinationViewName(appTopCombinationViewName) {
        return this.pathTemplates.appTopCombinationViewPathTemplate.match(appTopCombinationViewName).asset_combination_category;
    }
    /**
    ...
    matchCustomerIdFromAssetGroupName(assetGroupName) {
        return this.pathTemplates.assetGroupPathTemplate.match(assetGroupName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromAssetSetName(assetSetName) {
        return this.pathTemplates.assetSetPathTemplate.match(assetSetName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromAssetSetAssetName(assetSetAssetName) {
        return this.pathTemplates.assetSetAssetPathTemplate.match(assetSetAssetName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromAudienceName(audienceName) {
        return this.pathTemplates.audiencePathTemplate.match(audienceName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromBatchJobName(batchJobName) {
        return this.pathTemplates.batchJobPathTemplate.match(batchJobName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromBillingSetupName(billingSetupName) {
        return this.pathTemplates.billingSetupPathTemplate.match(billingSetupName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromCallViewName(callViewName) {
        return this.pathTemplates.callViewPathTemplate.match(callViewName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromCampaignName(campaignName) {
        return this.pathTemplates.campaignPathTemplate.match(campaignName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromCampaignAssetName(campaignAssetName) {
        return this.pathTemplates.campaignAssetPathTemplate.match(campaignAssetName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromCampaignDraftName(campaignDraftName) {
        return this.pathTemplates.campaignDraftPathTemplate.match(campaignDraftName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromCampaignGroupName(campaignGroupName) {
        return this.pathTemplates.campaignGroupPathTemplate.match(campaignGroupName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromCampaignLabelName(campaignLabelName) {
        return this.pathTemplates.campaignLabelPathTemplate.match(campaignLabelName)
            .customer_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    cartDataSalesViewPath(customerId) {
        return this.pathTemplates.cartDataSalesViewPathTemplate.render({
            customer_id: customerId,
        });
    }
    /**
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromCartDataSalesViewName(cartDataSalesViewName) {
        return this.pathTemplates.cartDataSalesViewPathTemplate.match(cartDataSalesViewName).customer_id;
    }
    /**
    ...
    matchCustomerIdFromChangeEventName(changeEventName) {
        return this.pathTemplates.changeEventPathTemplate.match(changeEventName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromChangeStatusName(changeStatusName) {
        return this.pathTemplates.changeStatusPathTemplate.match(changeStatusName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromClickViewName(clickViewName) {
        return this.pathTemplates.clickViewPathTemplate.match(clickViewName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromCustomerAssetName(customerAssetName) {
        return this.pathTemplates.customerAssetPathTemplate.match(customerAssetName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromCustomerLabelName(customerLabelName) {
        return this.pathTemplates.customerLabelPathTemplate.match(customerLabelName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromDataLinkName(dataLinkName) {
        return this.pathTemplates.dataLinkPathTemplate.match(dataLinkName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromDistanceViewName(distanceViewName) {
        return this.pathTemplates.distanceViewPathTemplate.match(distanceViewName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromExperimentArmName(experimentArmName) {
        return this.pathTemplates.experimentArmPathTemplate.match(experimentArmName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromGenderViewName(genderViewName) {
        return this.pathTemplates.genderViewPathTemplate.match(genderViewName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromInvoiceName(invoiceName) {
        return this.pathTemplates.invoicePathTemplate.match(invoiceName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromKeywordPlanName(keywordPlanName) {
        return this.pathTemplates.keywordPlanPathTemplate.match(keywordPlanName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromKeywordViewName(keywordViewName) {
        return this.pathTemplates.keywordViewPathTemplate.match(keywordViewName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromLifeEventName(lifeEventName) {
        return this.pathTemplates.lifeEventPathTemplate.match(lifeEventName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromLocationViewName(locationViewName) {
        return this.pathTemplates.locationViewPathTemplate.match(locationViewName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromMediaFileName(mediaFileName) {
        return this.pathTemplates.mediaFilePathTemplate.match(mediaFileName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromPerStoreViewName(perStoreViewName) {
        return this.pathTemplates.perStoreViewPathTemplate.match(perStoreViewName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromProductLinkName(productLinkName) {
        return this.pathTemplates.productLinkPathTemplate.match(productLinkName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromSharedSetName(sharedSetName) {
        return this.pathTemplates.sharedSetPathTemplate.match(sharedSetName)
            .customer_id;
    }
    /**
    ...
    matchTopicIdFromTopicConstantName(topicConstantName) {
        return this.pathTemplates.topicConstantPathTemplate.match(topicConstantName)
            .topic_id;
    }
    /**
    ...
    matchCustomerIdFromTopicViewName(topicViewName) {
        return this.pathTemplates.topicViewPathTemplate.match(topicViewName)
            .customer_id;
    }
    /**
    ...
    matchCustomerIdFromUserInterestName(userInterestName) {
        return this.pathTemplates.userInterestPathTemplate.match(userInterestName)
            .customer_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    videoEnhancementPath(customerId, videoEnhancement) {
        return this.pathTemplates.videoEnhancementPathTemplate.render({
            customer_id: customerId,
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromVideoEnhancementName(videoEnhancementName) {
        return this.pathTemplates.videoEnhancementPathTemplate.match(videoEnhancementName).customer_id;
    }
    /**
     ...
     */
    matchVideoEnhancementFromVideoEnhancementName(videoEnhancementName) {
        return this.pathTemplates.videoEnhancementPathTemplate.match(videoEnhancementName).video_enhancement;
    }
    /**
    ...
    matchCustomerIdFromWebpageViewName(webpageViewName) {
        return this.pathTemplates.webpageViewPathTemplate.match(webpageViewName)
            .customer_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    youTubeVideoUploadPath(customerId, videoUploadId) {
        return this.pathTemplates.youTubeVideoUploadPathTemplate.render({
            customer_id: customerId,
     ...
     * @returns {string} A string representing the customer_id.
     */
    matchCustomerIdFromYouTubeVideoUploadName(youTubeVideoUploadName) {
        return this.pathTemplates.youTubeVideoUploadPathTemplate.match(youTubeVideoUploadName).customer_id;
    }
    /**
     ...
     */
    matchVideoUploadIdFromYouTubeVideoUploadName(youTubeVideoUploadName) {
        return this.pathTemplates.youTubeVideoUploadPathTemplate.match(youTubeVideoUploadName).video_upload_id;
    }
    /**
     ...
     */
    close() {
        if (this.youTubeVideoUploadServiceStub && !this._terminated) {
            return this.youTubeVideoUploadServiceStub.then((stub) => {
...
exports.YouTubeVideoUploadServiceClient = YouTubeVideoUploadServiceClient;
//# sourceMappingURL=you_tube_video_upload_service_client.js.map