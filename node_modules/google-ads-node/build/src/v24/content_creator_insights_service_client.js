 ...
 * `src/v24/content_creator_insights_service_client_config.json`.
...
class ContentCreatorInsightsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.ContentCreatorInsightsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.contentCreatorInsightsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.ContentCreatorInsightsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .ContentCreatorInsightsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const contentCreatorInsightsServiceStubMethods = [
    ...
    generateCreatorInsights(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .generateCreatorInsights(request, options, wrappedCallback)
    ...
    generateTrendingInsights(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .generateTrendingInsights(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateTrendingInsights response %j', response);
            return [response, options, rawResponse];
        })
