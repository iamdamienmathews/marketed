 ...
 * `src/v24/audience_service_client_config.json`.
...
class AudienceServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AudienceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.audienceServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AudienceService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AudienceService, this._opts, this._providedCustomServicePath);
    ...
    mutateAudiences(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAudiences(request, options, wrappedCallback)
