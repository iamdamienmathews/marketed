 ...
 * `src/v24/conversion_value_rule_set_service_client_config.json`.
...
class ConversionValueRuleSetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.ConversionValueRuleSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversionValueRuleSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.ConversionValueRuleSetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .ConversionValueRuleSetService, this._opts, this._providedCustomServicePath);
    ...
    mutateConversionValueRuleSets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateConversionValueRuleSets(request, options, wrappedCallback)
