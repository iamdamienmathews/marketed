 ...
 * `src/v24/conversion_action_service_client_config.json`.
...
class ConversionActionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.ConversionActionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversionActionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.ConversionActionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .ConversionActionService, this._opts, this._providedCustomServicePath);
    ...
    mutateConversionActions(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateConversionActions(request, options, wrappedCallback)
