 ...
 * `src/v24/local_services_lead_service_client_config.json`.
...
class LocalServicesLeadServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.LocalServicesLeadService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.localServicesLeadServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.LocalServicesLeadService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .LocalServicesLeadService, this._opts, this._providedCustomServicePath);
    ...
    appendLeadConversation(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .appendLeadConversation(request, options, wrappedCallback)
    ...
    provideLeadFeedback(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .provideLeadFeedback(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('provideLeadFeedback response %j', response);
            return [response, options, rawResponse];
        })
