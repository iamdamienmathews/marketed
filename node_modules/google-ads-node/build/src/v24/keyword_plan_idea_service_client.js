 ...
 * `src/v24/keyword_plan_idea_service_client_config.json`.
...
class KeywordPlanIdeaServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.KeywordPlanIdeaService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanIdeaServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.KeywordPlanIdeaService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .KeywordPlanIdeaService, this._opts, this._providedCustomServicePath);
    ...
    generateKeywordHistoricalMetrics(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .generateKeywordHistoricalMetrics(request, options, wrappedCallback)
    ...
    generateAdGroupThemes(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .generateAdGroupThemes(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateAdGroupThemes response %j', response);
            return [response, options, rawResponse];
        })
    ...
    generateKeywordForecastMetrics(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .generateKeywordForecastMetrics(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateKeywordForecastMetrics response %j', response);
            return [response, options, rawResponse];
        })
