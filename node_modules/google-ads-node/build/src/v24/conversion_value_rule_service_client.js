 ...
 * `src/v24/conversion_value_rule_service_client_config.json`.
...
class ConversionValueRuleServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.ConversionValueRuleService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversionValueRuleServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.ConversionValueRuleService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .ConversionValueRuleService, this._opts, this._providedCustomServicePath);
    ...
    mutateConversionValueRules(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateConversionValueRules(request, options, wrappedCallback)
