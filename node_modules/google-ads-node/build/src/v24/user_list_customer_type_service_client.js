 ...
 * `src/v24/user_list_customer_type_service_client_config.json`.
...
class UserListCustomerTypeServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.UserListCustomerTypeService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.userListCustomerTypeServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.UserListCustomerTypeService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .UserListCustomerTypeService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const userListCustomerTypeServiceStubMethods = [
    ...
    mutateUserListCustomerTypes(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateUserListCustomerTypes(request, options, wrappedCallback)
