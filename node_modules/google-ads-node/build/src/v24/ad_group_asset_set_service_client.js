 ...
 * `src/v24/ad_group_asset_set_service_client_config.json`.
...
class AdGroupAssetSetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AdGroupAssetSetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupAssetSetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AdGroupAssetSetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AdGroupAssetSetService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroupAssetSets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAdGroupAssetSets(request, options, wrappedCallback)
