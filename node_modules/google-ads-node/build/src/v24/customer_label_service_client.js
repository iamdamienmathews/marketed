 ...
 * `src/v24/customer_label_service_client_config.json`.
...
class CustomerLabelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CustomerLabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CustomerLabelService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CustomerLabelService, this._opts, this._providedCustomServicePath);
    ...
    mutateCustomerLabels(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateCustomerLabels(request, options, wrappedCallback)
