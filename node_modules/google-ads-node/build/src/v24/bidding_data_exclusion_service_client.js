 ...
 * `src/v24/bidding_data_exclusion_service_client_config.json`.
...
class BiddingDataExclusionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.BiddingDataExclusionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.biddingDataExclusionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.BiddingDataExclusionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .BiddingDataExclusionService, this._opts, this._providedCustomServicePath);
    ...
    mutateBiddingDataExclusions(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateBiddingDataExclusions(request, options, wrappedCallback)
