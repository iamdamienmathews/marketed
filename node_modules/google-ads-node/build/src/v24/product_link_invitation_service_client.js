 ...
 * `src/v24/product_link_invitation_service_client_config.json`.
...
class ProductLinkInvitationServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.ProductLinkInvitationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.productLinkInvitationServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.ProductLinkInvitationService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .ProductLinkInvitationService, this._opts, this._providedCustomServicePath);
    ...
    createProductLinkInvitation(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .createProductLinkInvitation(request, options, wrappedCallback)
    ...
    updateProductLinkInvitation(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .updateProductLinkInvitation(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('updateProductLinkInvitation response %j', response);
            return [response, options, rawResponse];
        })
    ...
    removeProductLinkInvitation(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .removeProductLinkInvitation(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('removeProductLinkInvitation response %j', response);
            return [response, options, rawResponse];
        })
