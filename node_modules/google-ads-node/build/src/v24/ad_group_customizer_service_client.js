 ...
 * `src/v24/ad_group_customizer_service_client_config.json`.
...
class AdGroupCustomizerServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AdGroupCustomizerService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupCustomizerServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AdGroupCustomizerService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AdGroupCustomizerService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroupCustomizers(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAdGroupCustomizers(request, options, wrappedCallback)
