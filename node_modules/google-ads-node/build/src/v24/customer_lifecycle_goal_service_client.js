 ...
 * `src/v24/customer_lifecycle_goal_service_client_config.json`.
...
class CustomerLifecycleGoalServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.CustomerLifecycleGoalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerLifecycleGoalServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.CustomerLifecycleGoalService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .CustomerLifecycleGoalService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const customerLifecycleGoalServiceStubMethods = [
    ...
    configureCustomerLifecycleGoals(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .configureCustomerLifecycleGoals(request, options, wrappedCallback)
