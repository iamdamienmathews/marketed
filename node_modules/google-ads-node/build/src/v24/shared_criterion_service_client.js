 ...
 * `src/v24/shared_criterion_service_client_config.json`.
...
class SharedCriterionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.SharedCriterionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.sharedCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.SharedCriterionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .SharedCriterionService, this._opts, this._providedCustomServicePath);
    ...
    mutateSharedCriteria(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateSharedCriteria(request, options, wrappedCallback)
