 ...
 * `src/v24/batch_job_service_client_config.json`.
...
class BatchJobServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const runBatchJobMetadata = protoFilesRoot.lookup('.google.ads.googleads.v24.resources.BatchJob.BatchJobMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.BatchJobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.batchJobServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.BatchJobService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .BatchJobService, this._opts, this._providedCustomServicePath);
    ...
    mutateBatchJob(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateBatchJob(request, options, wrappedCallback)
    ...
    addBatchJobOperations(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .addBatchJobOperations(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('addBatchJobOperations response %j', response);
            return [response, options, rawResponse];
        })
    ...
    runBatchJob(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .runBatchJob(request, options, wrappedCallback)
     ...
     * @example <caption>include:samples/generated/v24/batch_job_service.run_batch_job.js</caption>
     * region_tag:googleads_v24_generated_BatchJobService_RunBatchJob_async
     */
     ...
     * @param {google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType} request.responseContentType
     *   The response content type setting. Determines whether the mutable resource
     *   or just the resource name should be returned.
     * @param {object} [options]
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.ads.googleads.v24.services.BatchJobResult|BatchJobResult} on 'data' event.
     ...
     *   {@link protos.google.ads.googleads.v24.services.BatchJobResult|BatchJobResult}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v24/batch_job_service.list_batch_job_results.js</caption>
     * region_tag:googleads_v24_generated_BatchJobService_ListBatchJobResults_async
     */
