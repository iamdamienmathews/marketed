 ...
 * `src/v24/brand_suggestion_service_client_config.json`.
...
class BrandSuggestionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.BrandSuggestionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.brandSuggestionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.BrandSuggestionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .BrandSuggestionService, this._opts, this._providedCustomServicePath);
    ...
    suggestBrands(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .suggestBrands(request, options, wrappedCallback)
