 ...
 * `src/v24/conversion_upload_service_client_config.json`.
...
class ConversionUploadServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.ConversionUploadService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversionUploadServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.ConversionUploadService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .ConversionUploadService, this._opts, this._providedCustomServicePath);
    ...
    uploadClickConversions(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .uploadClickConversions(request, options, wrappedCallback)
    ...
    uploadCallConversions(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .uploadCallConversions(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('uploadCallConversions response %j', response);
            return [response, options, rawResponse];
        })
