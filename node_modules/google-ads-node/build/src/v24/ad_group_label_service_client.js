 ...
 * `src/v24/ad_group_label_service_client_config.json`.
...
class AdGroupLabelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AdGroupLabelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupLabelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AdGroupLabelService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AdGroupLabelService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroupLabels(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAdGroupLabels(request, options, wrappedCallback)
