 ...
 * `src/v24/bidding_strategy_service_client_config.json`.
...
class BiddingStrategyServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.BiddingStrategyService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.biddingStrategyServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.BiddingStrategyService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .BiddingStrategyService, this._opts, this._providedCustomServicePath);
    ...
    mutateBiddingStrategies(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateBiddingStrategies(request, options, wrappedCallback)
