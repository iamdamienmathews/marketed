 ...
 * `src/v24/asset_group_service_client_config.json`.
...
class AssetGroupServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AssetGroupService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.assetGroupServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AssetGroupService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AssetGroupService, this._opts, this._providedCustomServicePath);
    ...
    mutateAssetGroups(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAssetGroups(request, options, wrappedCallback)
