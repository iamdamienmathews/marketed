 ...
 * `src/v24/reach_plan_service_client_config.json`.
...
class ReachPlanServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.ReachPlanService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.reachPlanServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.ReachPlanService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .ReachPlanService, this._opts, this._providedCustomServicePath);
    ...
    generateConversionRates(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .generateConversionRates(request, options, wrappedCallback)
    ...
    listPlannableLocations(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .listPlannableLocations(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listPlannableLocations response %j', response);
            return [response, options, rawResponse];
        })
    ...
    listPlannableProducts(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .listPlannableProducts(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listPlannableProducts response %j', response);
            return [response, options, rawResponse];
        })
    ...
    generateReachForecast(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .generateReachForecast(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('generateReachForecast response %j', response);
            return [response, options, rawResponse];
        })
    ...
    listPlannableUserLists(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .listPlannableUserLists(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listPlannableUserLists response %j', response);
            return [response, options, rawResponse];
        })
    ...
    listPlannableUserInterests(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls
            .listPlannableUserInterests(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('listPlannableUserInterests response %j', response);
            return [response, options, rawResponse];
        })
