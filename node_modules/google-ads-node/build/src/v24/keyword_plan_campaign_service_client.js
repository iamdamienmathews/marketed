 ...
 * `src/v24/keyword_plan_campaign_service_client_config.json`.
...
class KeywordPlanCampaignServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.KeywordPlanCampaignService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanCampaignServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.KeywordPlanCampaignService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .KeywordPlanCampaignService, this._opts, this._providedCustomServicePath);
    ...
    mutateKeywordPlanCampaigns(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateKeywordPlanCampaigns(request, options, wrappedCallback)
