 ...
 * `src/v24/ad_group_criterion_service_client_config.json`.
...
class AdGroupCriterionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AdGroupCriterionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.adGroupCriterionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AdGroupCriterionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services
                    .AdGroupCriterionService, this._opts, this._providedCustomServicePath);
    ...
    mutateAdGroupCriteria(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAdGroupCriteria(request, options, wrappedCallback)
