 ...
 * `src/v24/asset_service_client_config.json`.
...
class AssetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v24.services.AssetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.assetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ads.googleads.v24.services.AssetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ads.googleads.v24.services.AssetService, this._opts, this._providedCustomServicePath);
    ...
    mutateAssets(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls
            .mutateAssets(request, options, wrappedCallback)
